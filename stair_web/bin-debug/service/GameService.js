...
var GameService = (function () {
    ...
    GameService.stringToHex = function (s) {
        var r = "";
    ...
    GameService.des = function (key, message, encrypt, mode, iv, padding) {
        ...
        var keys = GameService.des_createKeys(key);
        var m = 0;
    ...
    GameService.des_createKeys = function (key) {
        //declaring this locally speeds things up a bit
