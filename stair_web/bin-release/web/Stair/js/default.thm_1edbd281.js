window.skins={};
	...
	_proto._Group20_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Image1_i(),this.exit_btn_i(),this.pay_table_btn_i(),this._Label1_i(),this._Label2_i(),this.mute_toggle_i(),this._Group5_i(),this._Group6_i(),this.on9_bug_i(),this.record_gp_i(),this._Group17_i(),this._Group18_i(),this._Group19_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
