window.skins={};
	...
	function gameUISkin_v0() {
		...
		eui.Binding.$bindProperties(this, ["hostComponent.result_panel.v.gp"],[0],this._Group17,"visible");
		eui.Binding.$bindProperties(this, ["hostComponent.result_panel.img.lr"],[0],this._Image35,"source");
		eui.Binding.$bindProperties(this, ["hostComponent.result_panel.v.0"],[0],this._Image35,"visible");
		eui.Binding.$bindProperties(this, ["hostComponent.result_panel.v.1"],[0],this._Image36,"visible");
		eui.Binding.$bindProperties(this, ["hostComponent.result_panel.img.34"],[0],this._Image37,"source");
		eui.Binding.$bindProperties(this, ["hostComponent.result_panel.v.2"],[0],this._Image37,"visible");
		eui.Binding.$bindProperties(this, ["hostComponent.result_panel.v.3"],[0],this._Image38,"visible");
		eui.Binding.$bindProperties(this, ["hostComponent.result_panel.img.sm"],[0],this._Image39,"source");
		eui.Binding.$bindProperties(this, ["hostComponent.result_panel.v.4"],[0],this._Image39,"visible");
		eui.Binding.$bindProperties(this, ["hostComponent.finalScore_text"],[0],this._Label5,"text");
		eui.Binding.$bindProperties(this, ["hostComponent.pay_table_gp"],[0],this._Group18,"visible");
		eui.Binding.$bindProperties(this, ["hostComponent.pay_table_page_image"],[0],this._Image41,"source");
		...
		eui.Binding.$bindProperties(this, ["hostComponent.notice.visible"],[0],this._Group19,"visible");
	...
	_proto._Group20_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Image1_i(),this.exit_btn_i(),this.pay_table_btn_i(),this._Label1_i(),this._Label2_i(),this.mute_toggle_i(),this._Group5_i(),this._Group6_i(),this.on9_bug_i(),this.record_gp_i(),this._Group17_i(),this._Group18_i(),this._Group19_i(),this._Image44_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	_proto.record_gp_i = function () {
		...
		t.x = 0;
		t.y = 1280;
		t.elementsContent = [this._Group14_i(),this.record_content_i()];
		return t;
	};
	_proto._Group14_i = function () {
		...
		t.x = 0;
		t.y = 182;
		t.elementsContent = [this.record_bg_img_i(),this.up_btn_i(),this.clear_record_btn_i()];
		return t;
	};
	...
	_proto._Group17_i = function () {
		...
		t.x = 30;
		t.y = 247;
		t.elementsContent = [this._Group15_i(),this._Group16_i(),this._Label5_i(),this.result_panel_close_i()];
		return t;
	};
	_proto._Group15_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Image32_i(),this._Image33_i(),this._Image34_i()];
		return t;
	};
	...
	_proto._Group16_i = function () {
		...
		t.x = 11;
		t.y = 85;
		t.elementsContent = [this._Image35_i(),this._Image36_i(),this._Image37_i(),this._Image38_i(),this._Image39_i()];
		return t;
	};
	...
	_proto._Group18_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Image40_i(),this._Image41_i(),this.pay_table_next_btn_i(),this.pay_table_back_btn_i(),this.pay_table_close_btn_i()];
		return t;
	};
